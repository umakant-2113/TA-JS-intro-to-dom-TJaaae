...
allHrsArray.forEach((Element)=>console.log(Element.style.border="1px solid tomato"));
// Change the background of all the hr to "antiquewhite" using for of loop.
for(let allhr of allHrsArray){
  console.log(allhr.style.backgroundColor="antiquewhite");
}
// Change the 'border-radius' of all the hr to "5px" using array.
allHrsArray.forEach((Element)=>console.log(Element.style.borderRadius="5px"));
...
allImage.forEach((Element)=>console.log(Element.style.border=`2px solid purple`));
// Hide the box number 17 (last box).
let box17=document.querySelector(`.seventeen`);
box17.style.display="none";
// Change the border of all the hr element from solid to dashed type
allHrsArray.forEach((Element)=>console.log(Element.style.border=`2px dashed black`));
...
let boxs= Array.from(allBox)
console.log(boxs);
boxs.forEach((element,index)=>{
  index+=1;
  if(index%2!=0){
    console.log(element.style.backgroundColor="aliceblue");
  }
})
...
input1.placeholder="Enter you email!"
console.log(input1);
